                ...
                ?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h4 class="my-auto font-weight-bold mb-0 ">Data Pengeluaran</h4>
                            <div class="d-flex">
                                ...
                                <a href="#" class="btn btn-primary shadow-sm rounded-0" data-toggle="modal" data-target="#addPengeluaran"><i
                                    class="fas fa-plus fa-sm text-white-500"></i> Add Pengeluaran</a>
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-bold  mx-3 mt-3" id="formAddPengeluaranLabel">Form Pengeluaran</h5>
                        ...
                        <form name="form_add_transaksi" action="<?php echo base_url().'pengeluaran/add' ?>" method="post" class="user needs-validation mx-3 mb-4" novalidate>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"  class="form-control" placeholder='Total Uang' name="total"  required>
                                    <div class="invalid-feedback">
